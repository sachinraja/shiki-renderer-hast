...
it('has proper encoding', async () => {
  ...
  expect(toHtml(tree)).toMatchInlineSnapshot(
    `"<pre class=\\"shiki\\" style=\\"background-color: #2e3440ff\\"><code><span class=\\"line\\"><span style=\\"color: #81A1C1\\">&#x3C;div></span><br></span><span class=\\"line\\"><span style=\\"color: #D8DEE9FF\\">      </span><span style=\\"color: #81A1C1\\">&#x3C;span></span><span style=\\"color: #D8DEE9FF\\">hello</span><span style=\\"color: #81A1C1\\">&#x3C;/span></span><br></span><span class=\\"line\\"><span style=\\"color: #D8DEE9FF\\">    </span><span style=\\"color: #81A1C1\\">&#x3C;/div></span><br></span></code></pre>"`
  )
})
